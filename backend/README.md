...
## Project Structure
    ...
    ├── testapiautoconnect_104172  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_104172`
...
2. Clone this repo and `cd testapiautoconnect_104172`
